define(['basic/entity', 'geo/v2', 'lib/animation', 'core/graphic'],
	function(Entity, V2, Animation, g) {
		...
		function ArrowHelper(pos, playscene) {
			...
			var anim2 = new Animation('img/DanceDanceRevolution.png', new V2(-50, 210), 4, 0, false);
			anim2.frame = 0;
			var y = Math.round(enemyData['red'].a * Math.pow((1 - percentage * 2), 2) * 100 - enemyData['red'].a * 100);
			var anim3 = new Animation('img/DanceDanceRevolution.png', new V2(-50, 400), 4, 0, false);
			anim3.frame = 1;
			var y = Math.round(enemyData['blue'].a * Math.pow((1 - percentage * 2), 2) * 100 - enemyData['blue'].a * 100);
			var anim4 = new Animation('img/DanceDanceRevolution.png', new V2(-50, 550), 4, 0, false);
			anim4.frame = 3;
			this.add(anim1);
			this.add(anim2);
			this.add(anim3);
